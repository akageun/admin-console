<template>
    <sui-sidebar-pushable>
        <common-sidebar/>
        <sui-sidebar-pusher :dimmed="this.$store.state.visible" @click="menuVisibleFalseStore">
            <common-header/>
            ...
            <sui-container class="main" text>
                ...
                <!--        <sui-image src="/static/bundle/assets/logo.png" size="mini" centered/>-->
                <sui-image src="/static/bundle/assets/logo.png" centered/>
            </sui-container>
...
<script>
    ...
    export default {
        ...
        methods: {
            menuVisibleFalseStore() {
                this.$store.commit('menuVisible', false);
            }
        },
        created() {
